...
**Currently blocked on:** installing CREPE, the accurate pitch tracker, which gates every
cent-level question. **Next up:** the first real-audio batch, including a take with deliberate
mistakes so there's a known right answer to grade against.
