...
A second skill (`maestro-entry`) handles my private research journaling. It's excluded from
this repo because it's a personal notebook helper, not something anyone else would use.
